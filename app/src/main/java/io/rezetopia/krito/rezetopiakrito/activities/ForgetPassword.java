...
public class ForgetPassword extends AppCompatActivity {
    ...
    public static String URL_RESET = "http://rezetopia.dev-krito.com/app/resetpass.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.rezetopia.krito.rezetopiakrito.R.layout.activity_forget_password);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!phone){
                    URL_RESET = "http://rezetopia.dev-krito.com/app/resetpass.php";
                }
                else if(phone){
                    URL_RESET = "http://rezetopia.dev-krito.com/app/resetsms.php";
                }
                validate();
