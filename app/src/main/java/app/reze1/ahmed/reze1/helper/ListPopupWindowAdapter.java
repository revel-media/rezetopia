...
public class ListPopupWindowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(app.reze1.ahmed.reze1.R.layout.menu_image_custom, parent, false);
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            tvTitle = view.findViewById(app.reze1.ahmed.reze1.R.id.menuTextCustom);
            ivImage = view.findViewById(app.reze1.ahmed.reze1.R.id.menuImageCustom);
        }
    }
}
