...
import app.reze1.ahmed.reze1.core.core.users.getall.GetUsersInteractor;
...
public class GetUsersPresenter implements GetUsersContract.Presenter, GetUsersContract.OnGetAllUsersListener {
    ...
    public GetUsersPresenter(GetUsersContract.View view) {
        this.mView = view;
        mGetUsersInteractor = new GetUsersInteractor((app.reze1.ahmed.reze1.core.core.users.getall.GetUsersContract.OnGetAllUsersListener) this);
    }
