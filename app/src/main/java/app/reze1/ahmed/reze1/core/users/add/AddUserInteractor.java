...
public class AddUserInteractor implements app.reze1.ahmed.reze1.core.users.add.AddUserContract.Interactor {
    private app.reze1.ahmed.reze1.core.users.add.AddUserContract.OnUserDatabaseListener mOnUserDatabaseListener;

    public AddUserInteractor(app.reze1.ahmed.reze1.core.users.add.AddUserContract.OnUserDatabaseListener onUserDatabaseListener) {
